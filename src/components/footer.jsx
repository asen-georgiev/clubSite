                        ...
                        <Col>
                            <Navbar>
                                <Nav className="mr-auto flex-column">
                                    ...
                                    <Row className="ml-0">
                                        <a className="nav-link p-0 mr-2"
                                           href="https://www.facebook.com/Iseido-Shotokan-Karate-club-142528162447145">
                                            <FontAwesomeIcon icon={faFacebook}/></a>
                                        <a className="nav-link p-0 mr-2" href="https://www.instagram.com/flurviansea/">
                                            <FontAwesomeIcon icon={faInstagram}/></a>
                                        <a className="nav-link p-0 mr-2" href="https://www.linkedin.com/in/asen-georgiev-214527180/">
                                            <FontAwesomeIcon icon={faLinkedin}/></a>
                                        <a className="nav-link p-0" href="https://www.linkedin.com/in/asen-georgiev-214527180/">
